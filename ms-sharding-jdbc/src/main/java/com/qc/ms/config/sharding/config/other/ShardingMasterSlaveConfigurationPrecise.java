...
import com.qc.ms.config.sharding.algorithm.PreciseModuloShardingDatabaseAlgorithm;
...
public final class ShardingMasterSlaveConfigurationPrecise implements DataSourceConfiguration {
    @Override
    public DataSource getDataSource() throws SQLException {
        ...
        shardingRuleConfig.getBroadcastTables().add("address");
